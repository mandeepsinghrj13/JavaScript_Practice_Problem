...
let numberThree = +userNumberThree;
...
if (
  additionMultiplication > modAddition &&
  additionMultiplication > additionDivision &&
  additionMultiplication > multiplicationAddition
) {
  console.log("Max Value is : " + additionMultiplication);
} else if (
  modAddition > additionDivision &&
  modAddition > multiplicationAddition
) {
